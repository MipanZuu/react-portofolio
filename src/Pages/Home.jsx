...
function Home() {
  ...
  const greetings = [
    ...
    { word: "Hola", gradient: "bg-gradient-to-r from-yellow-400 to-orange-500" },
    { word: "Bonjour", gradient: "bg-gradient-to-r from-green-400 to-teal-500" },
    { word: "Ciao", gradient: "bg-gradient-to-r from-red-400 to-pink-500" },
    { word: "こんにちは", gradient: "bg-gradient-to-r from-pink-400 to-purple-500" },
    { word: "안녕하세요", gradient: "bg-gradient-to-r from-purple-400 to-indigo-500" },
    ...
    { word: "Привет", gradient: "bg-gradient-to-r from-indigo-400 to-purple-600" },
    { word: "नमस्ते", gradient: "bg-gradient-to-r from-amber-400 to-red-500" },
    { word: "Salam", gradient: "bg-gradient-to-r from-green-400 to-emerald-600" },
  ];
    ...
    <main className="overflow-hidden">
      ...
      >
        <h1 className="text-4xl md:text-6xl font-bold">
          <span
            ref={greetingRef}
            className={`pb-10 inline-block bg-clip-text text-transparent ${greetings[currentGreeting].gradient}`}
          >
