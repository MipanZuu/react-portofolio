...
function TravelingSection() {
  ...
  return (
    <main className="overflow-hidden">
      <section
        ref={travelingRef}
        className="min-h-screen no-scrollbar flex flex-col items-center justify-center py-12 md:py-24 bg-gray-100 dark:bg-dark-mode2"
      >
        {/* Title */}
        <h2 className="text-3xl md:text-5xl font-bold mb-6 md:mb-10 text-center text-gray-900 dark:text-white">
          Traveling Section
        </h2>
        <p className="text-base md:text-lg text-center text-gray-600 dark:text-gray-300 mb-6 md:mb-10">
        ...
        >
          {[
            ...
            <div
              key={index}
              className="travel-card flex-shrink-0 w-[95vw] sm:w-[85vw] md:w-[70vw] lg:w-[55vw] h-auto flex flex-col md:flex-row bg-gray-800 text-white rounded-3xl shadow-lg border border-gray-700 p-6 md:p-10"
            >
              {/* Left Column: Text */}
              <div className="w-full md:w-1/2 flex flex-col justify-center">
                <h1
                  className={`text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-extrabold leading-tight tracking-tight mb-4 ${card.color}`}
                >
                  {card.title}
                </h1>
                ...
                <p className="text-xs md:text-sm mt-2 text-gray-400">
                  Climb to the peaks and witness nature in its raw and pure
                  form.
                </p>
              </div>
              ...
              <div className="w-full md:w-1/2 flex justify-center items-center">
                <div className="w-4/5 h-32 sm:h-40 md:h-48 lg:h-64 flex items-center justify-center bg-gray-900 rounded-lg border border-gray-600">
                  <span className="text-gray-400 font-bold text-sm sm:text-lg lg:text-2xl">
                    Image Placeholder
                  </span>
                </div>
              </div>
